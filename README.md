...
- Play MIDI files using FluidSynth (Yoshimi-based real-time synthesis planned)
...
- **Raspberry Pi**: synthesis engine (FluidSynth, Yoshimi), playback, control, I²S DAC, USB-UART
- **TFT-LCD**: dedicated UI display that renders images generated by the core Python application (not a general-purpose system display)
