...
"""
extract_yoshimi_patches_symlink.py
...
Default output file:
    <bank-root>/yoshimi.patches.symlink.json

Default symbolic-link directory:
    /home/pi/sf2/yoshimi_links

Examples:
    python3 extract_yoshimi_patches_symlink.py /usr/share/yoshimi/banks

    python3 extract_yoshimi_patches_symlink.py /usr/share/yoshimi/banks \
        -o /home/pi/sf2/yoshimi.patches.symlink.json
...
DEFAULT_OUTPUT_BASENAME = "yoshimi.patches.symlink.json"
